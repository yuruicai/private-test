...
public final class URL implements Serializable {
    ...
    public static class Builder {
        ...
        public Builder addContentBodyEntity(String key,ContentBody contentBody) {
            if (entitys == null) {
                entitys = new HashMap<String, Object>();
            }
            entitys.put(key, contentBody);
            return this;
        }

        public Builder addStringEntity(String key,String value) {
            if (entitys == null) {
                entitys = new HashMap<String, Object>();
            }
        ...
        public Builder addFileEntity(String key,File file) {
            if (entitys == null) {
                entitys = new HashMap<String, Object>();
            }
            entitys.put(key, file);
            return this;
        }
    }
