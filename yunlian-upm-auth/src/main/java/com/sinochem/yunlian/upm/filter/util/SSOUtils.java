...
public class SSOUtils {
    ...
    public static final String SALT = "0d8c65ea4257a0701b398ba5627aab3ad747a7bd9ed043be54b5794e20595fc94661b6f9751c9c0c";
    public static int TIMEOUT = 12 * 3600;
    ...
    public static String getEntry(HttpServletRequest request) throws UnsupportedEncodingException {
        ...
        String host = SSOUtils.getHost(request);
        if (entry.indexOf("/") != -1) {
    ...
    public static String getMD5ofStr(String message) {
        try {
            ...
            LOG.error("SSO Auth MD5 ERROR" + e.getMessage());
