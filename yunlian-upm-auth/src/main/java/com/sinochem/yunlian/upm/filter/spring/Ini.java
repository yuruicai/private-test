...
class Ini implements Map<String, Ini.Section> {
    ...
    public static Ini fromResourcePath(String resourcePath) throws RuntimeException {
    ...
    public void loadFromPath(String resourcePath) throws RuntimeException {
        InputStream is;
        try {
    ...
    public void load(String iniConfig) throws RuntimeException {
        load(new Scanner(iniConfig));
    }

    public void load(InputStream is) throws RuntimeException {
        if (is == null) {
