...
import com.sinochem.yunlian.upm.api.util.ProtectByBase64;
...
public class UserV2Controller {
    ...
    public Response modPassword(String id ,String oldPassword, String newPassword1, String newPassword2){
        ...
        oldPassword = ProtectByBase64.getBase64(oldPassword);
        newPassword1 = ProtectByBase64.getBase64(newPassword1);
        newPassword2 = ProtectByBase64.getBase64(newPassword2);
