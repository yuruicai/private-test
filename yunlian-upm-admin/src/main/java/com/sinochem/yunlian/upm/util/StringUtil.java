...
public class StringUtil {
    ...
    public static String implode(Iterable<?> strings, String delimit) {
        return Joiner.on(delimit).skipNulls().join(strings);
    }

    public static Iterable<String> explode(String string, String delimit) {
        return Splitter.on(delimit).omitEmptyStrings().trimResults().split(string);
    }
