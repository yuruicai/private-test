...
<html>
    ...
    <body id="login">
        <div id="doc">
            <div id="l-hd">
                <#--<a class="logo" href="/" title="壹化云链统一登录中心">-->
                    <h1 style="margin-left: 10px; border-left: 2px solid #3361a4;padding-left: 10px;color: #3361a4; line-height: 36px;font-size: 28px; letter-spacing: 2px;background: url('/static/images/login-center-logo.png') no-repeat 10px;text-indent: -999px;width: 179px;height: 36px;">统一登录中心</h1>
                <#--</a>-->
            </div>
                ...
                <div class="login-section-bg">
                    <div class="login-section">
                        <div class="login-container login-form-container" >
                            <#assign
                            showErrorTip = error?? || (freezeLimit?? && freezeLimit != -1)
                            isNeedCaptcha = needCaptcha?? && needCaptcha == "true"
                            />
                            <#if showErrorTip>
                            <div id="form-tip" class="tip-error">
                                <#if error??>
                                ${error}，<a tabindex="-1" class="forget-password" 
                                    href="/pass/forget">忘记密码？</a>
                                <#elseif freezeLimit?? && freezeLimit != -1>
                                多次重试将临时冻结账号，剩余重试次数${freezeLimit}
                                </#if>
                            </div>
                            </#if>
                            ...
                            <form class="login-form" action="/login" method="post">
                                <div class="form-field">
                                    ...
                                    <span class="mail-suffix">@fengjr.com</span>
                                </div>
                                <div class="form-field">
